var messages_ref=firebase.database().ref('ADMINISTRATION/messages/');
var message_arr;
var no_of_message;
...
{
  firebase.database().ref('ADMINISTRATION/messages/'+message_arr[no_of_message-location_num][0]).remove();

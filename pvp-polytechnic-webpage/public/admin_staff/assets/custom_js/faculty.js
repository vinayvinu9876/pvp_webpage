...
try{
    ...
    {
      console.log("There is no data of faculties "+e);
    }
...
var add_qualification_elem="<h4 id='fac"+i+"_qualification'></h4><br />";
  var add_design_elem="<h4 id='fac"+i+"_designation'>GOOD</h4><h4 id='fac"+i+"_years_of_exp'></h4></div></div> ";
...
function write_all_fac_det(num_of_fac,fac_array)
{
  ...
  for(i=1;i<=num_of_fac;i++)
  {
    console.log("Writing fda data");
    console.log(fac_array);
    ...
    var fac_years_of_exp="fac"+i+"_years_of_exp";
    ...
    var years_of_exp_elem=document.getElementById(fac_years_of_exp);
    ...
    fac_years_of_exp.innerHTML=fac_array[i-1][1].years_of_exp;

...
catch(e)
{
  ...
  no_of_img=0;
  document.getElementById('gallerySLide').innerHTML="<h1>No Image</h1>";
};
...
for(i=1;i<=no_of_img;i++)
  {
    ...
    var img_html="<a href='img/gallery/img-large1.jpg' title='This is title' id='img_href"+i+"'><img class='gallery_img' src='img/gallery/img-small1.jpg' alt='img' id='g_img"+i+"'/><span class='view_btn'>View</span></a>";

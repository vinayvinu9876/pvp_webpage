...
*/
  ...
  var name_fac1,designation_fac1,years_of_exp_fac1;
...
get_elem.innerHTML="<center><h2>TEACHING FACULTY</h2></center>";
  ...
  for(i=1;i<=num_of_fac;i++)
  {
    ...
    var add_img_elem="<img src='../images1/default_avatar.png' class='img-rounded width='250' heigth='250' id='fac"+i+"_img'> <h3 id='fac"+i+"_name'>HELLO from "+i+"</h3><hr />"
    var add_qualification_elem="<h4 id='fac"+i+"_qualification'></h4>";
  var add_design_elem="<h4 id='fac"+i+"_designation'></h4><h4 id='fac"+i+"_years_of_exp'></h4></div></div> ";
...
function write_all_fac_det(num_of_fac,fac_array)
{
  ...
  for(i=1;i<=num_of_fac;i++)
  {
    ...
    var years_of_exp_ref="fac"+i+"_years_of_exp";
    ...
    years_of_exp_elem.innerHTML=fac_array[i-1][1].years_of_exp;
